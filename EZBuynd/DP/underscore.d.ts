...
interface UnderscoreStatic {
    ...
    **/
    ...
    /* When defining data as well, the template function will return the HTML rather than the function
     * that can be called to render the HTML
    **/
    template(templateString: string, data: any, settings?: _.TemplateSettings): any;
